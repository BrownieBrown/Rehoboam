...
- **League-wide calibration (2026-09-15)**: every session writes `rehoboam.predictions` for every live player; the ingestion app reports each finished matchday (`calibration_reports`) with the gate verdict spec §4 defines; PR E of the data foundation.
